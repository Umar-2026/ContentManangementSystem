...
- [8. Data Architecture](#8-data-architecture)
    - [8.1 Database Schema (Core Tables)](#81-database-schema-core-tables)
    - [8.2 Data Access Patterns](#82-data-access-patterns)
    - [8.3 Caching Strategy](#83-caching-strategy)
- [9. API Design](#9-api-design)
    - [9.1 REST API Endpoint Summary](#91-rest-api-endpoint-summary)
    - [9.2 API Authentication Flow](#92-api-authentication-flow)
- [10. Security Architecture](#10-security-architecture)
    - [10.1 Security Controls by Layer](#101-security-controls-by-layer)
    - [10.2 OWASP Compliance Mapping](#102-owasp-compliance-mapping)
- [11. Deployment Architecture](#11-deployment-architecture)
    - [11.1 Deployment Overview](#111-deployment-overview)
    - [11.2 Infrastructure Components](#112-infrastructure-components)
